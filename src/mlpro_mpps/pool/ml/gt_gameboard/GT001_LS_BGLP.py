...
This module provides a default implementation of the LS-BGLP in MLPro-MPPS as a GT Game Board.
"""
...
## -------------------------------------------------------------------------------------------------
## -------------------------------------------------------------------------------------------------
class LS_BGLP_GTGameBoard(GameBoard):

    C_TYPE = 'Game Board'
    C_NAME = 'MPPS-based LS-BGLP - GT Game Board'
...
## -------------------------------------------------------------------------------------------------
    def __init__(self,
        ...
        super().__init__(p_mode = Mode.C_MODE_SIM, 
                         p_latency = None, 
                         p_fct_strans = LS_BGLP4GT(p_name='LS_BGLP_GT',
                                                   p_logging=p_logging,
                                                   p_parent=self), 
                         p_fct_reward = None, 
                         p_fct_success = None, 
        ...
        self.set_power          = ['CB1_PowerConsumption',
                                   ...
                                   'VC2_PowerConsumption',
                                   'SC2_PowerConsumption',
                                   'VC1_PowerConsumption_1',
                                   'ViC_PowerConsumption',
                                   'BE2_PowerConsumption',
                                   'RF_PowerConsumption',
                                   'BuE_PowerConsumption',
                                   'DV_PowerConsumption',
                                   'VC3_PowerConsumption']
