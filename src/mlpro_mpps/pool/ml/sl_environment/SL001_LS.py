...
## -- Package : mlpro_mpps.pool.ea_environment
## -- Module  : EA001_LS.py
## -------------------------------------------------------------------------------------------------
## -- History :
...
## -------------------------------------------------------------------------------------------------
## -------------------------------------------------------------------------------------------------
class LS_SLEnv(Environment):

    C_TYPE = 'Environment'
    C_NAME = 'MPPS-based Liquid Station - SL Environment'
    C_CYCLE_LIMIT = 0  # Recommended cycle limit for training episodes


## -------------------------------------------------------------------------------------------------
    def __init__(self,
                 p_reward_type=Reward.C_TYPE_EVERY_ACTION,
        ...
        super().__init__(p_mode = Mode.C_MODE_SIM, 
                         p_latency = None, 
                         p_fct_strans = LS4SL(p_name='Liquid_Station_RL',
                                              p_logging=p_logging,
                                              p_parent=self
                                              ), 
                         p_fct_reward = None, 
...
## -------------------------------------------------------------------------------------------------
    def calc_reward(self):
        ...
        reward = [sum(transport), sum(overlfow), sum(power)]
